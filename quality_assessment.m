function [PSNR, rmse_total, ergas, sam, uiqi, psnrall, sam_map,mse_map] = quality_assessment(ground_truth, estimated, ignore_edges, ratio_ergas)
...
mse_map = sum((ground_truth-estimated).^2,3);
